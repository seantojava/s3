...
<div id="header">
  <div class="header_inner">
    ...
    <div class="search">
    <!-- 原文档的ip端口号为8085，更改为18085 -->
      <form action="http://localhost:28085/search.html" id="searchForm" name="query" method="GET">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://localhost:28089/cart/cart.html" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
